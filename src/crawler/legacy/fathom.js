(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.fathom = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
const {
    rule,
    ruleset,
    dom,
...
module.exports.atMost = atMost;
module.exports.conserveScore = conserveScore;
module.exports.note = note;
module.exports.props = props;
module.exports.clusters = clusters;
module.exports.score = score;
module.exports.type = type;
module.exports.typeIn = typeIn;
module.exports.distance = distance;
module.exports.euclidean = euclidean;

},{"fathom-web":5,"fathom-web/clusters":2}],2:[function(require,module,exports){
'use strict';
...
},{"./utilsForFrontend":11,"wu":12}],3:[function(require,module,exports){
"use strict";
...
class Fnode {
    ...
    conserveScoreFrom(leftFnode, leftType, rightType) {
        let types;
        if (!(types = (0, _utilsForFrontend.setDefault)(this._conservedScores, leftFnode, () => new Set())).has(leftType)) {
            types.add(leftType);
    ...
    _typeRecordForSetting(type) {
        return (0, _utilsForFrontend.setDefault)(this._types, type, () => ({ score: 1 }));
    }
    ...
    _typeRecordForGetting(type) {
        return (0, _utilsForFrontend.getDefault)(this._types, type, () => ({ score: 1 }));
    }
...
exports.Fnode = Fnode;
},{"./side":10,"./utilsForFrontend":11}],5:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.typeIn = exports.type = exports.score = exports.ruleset = exports.rule = exports.props = exports.out = exports.note = exports.nearest = exports.dom = exports.conserveScore = exports.clusters = exports.atMost = exports.and = undefined;
...
exports.and = _side.and;
exports.atMost = _side.atMost;
exports.clusters = _clusters.clusters;
exports.conserveScore = _side.conserveScore;
exports.dom = _lhs.dom;
exports.nearest = _side.nearest;
exports.note = _side.note;
exports.out = _rhs.out;
exports.props = _side.props;
exports.rule = _rule.rule;
exports.ruleset = _ruleset.ruleset;
exports.score = _side.score;
exports.type = _side.type;
exports.typeIn = _side.typeIn;
},{"./clusters":2,"./lhs":6,"./rhs":7,"./rule":8,"./ruleset":9,"./side":10}],6:[function(require,module,exports){
'use strict';
...
class TypeMaxLhs extends AggregateTypeLhs {
    ...
    fnodes(ruleset) {
        ...
        return (0, _utilsForFrontend.setDefault)(ruleset.maxCache, this._type, function maxFnodesOfType() {
            return (0, _utilsForFrontend.maxes)(getSuperFnodes(), fnode => fnode.scoreSoFarFor(self._type));
        });
    }
}
...
},{"./clusters":2,"./utilsForFrontend":11}],7:[function(require,module,exports){
'use strict';
...
},{"./utilsForFrontend":11}],8:[function(require,module,exports){
'use strict';
...
function rule(lhs, rhs) {
    ...
    return new (rhs instanceof _rhs.OutwardRhs ? OutwardRule : InwardRule)(lhs, rhs);
}
...
},{"./fnode":4,"./rhs":7,"./utilsForFrontend":11,"wu":12}],9:[function(require,module,exports){
'use strict';
...
class Ruleset {
     ...
     */
    against(doc) {
        return new BoundRuleset(doc, this._inRules, this._outRules, this._rulesThatCouldEmit, this._rulesThatCouldAdd);
    }
...
},{"./exceptions":3,"./fnode":4,"./rhs":7,"./rule":8,"./utilsForFrontend":11}],10:[function(require,module,exports){
'use strict';
...
exports.conserveScore = conserveScore;
exports.and = and;
...
},{"./clusters":2,"./lhs":6,"./rhs":7}],11:[function(require,module,exports){
'use strict';
...
},{"./exceptions":3,"wu":12}],12:[function(require,module,exports){
